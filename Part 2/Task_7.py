...
poly5=Add(Add(Add(Sub(Y(False,0),Pow(Y(False,0),Int(8))),Int(5)),Int(20)),Int(50))
p5dic={}
...
for x in range(len(p5list)):
    ...
    if y=="+" :  
        ...
        bef=p5list[x-1]
        af=p5list[x+1]
        if "X" not in bef and "Y" not in bef:
            if "X" not in af and "Y" not in af: 
...
#print(finaldic)
poly5=Add(Add(Add(Sub(Add(Y(False,0),Pow(Y(False,0),Int(8))),Pow(Y(False,0),Int(8))),Int(5)),Int(20)),Int(50))
p5dic={}
p5list=str(poly5).split()
#print(p5list)
#for x in range(len(p5list)):
